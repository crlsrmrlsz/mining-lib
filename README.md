...
[![npm](https://img.shields.io/npm/v/mining-lib.svg)](https://www.npmjs.com/package/mining-lib)
[![license: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![live demo](https://img.shields.io/badge/demo-live-brightgreen.svg)](https://crlsrmrlsz.github.io/mining-lib/)

mining-lib turns a CSV or NDJSON event log into an interactive **Directly-Follows Graph** — the map of which activity tends to follow which across your cases. It runs entirely in the browser, ships as a framework-agnostic web component, and weighs ~70 kB gzipped (D3 + dagre under the hood).

![A loan-origination process rendered in a dark analytics dashboard. Mean-time mode lights up the re-underwriting loop in amber.](docs/screenshots/dark-analytics.png)
...
You give it an event log; it gives you a graph your users can explore.

```
   event log                 mining-lib                    your page
  CSV / NDJSON  ──parse──▶  build DFG + dagre  ──render──▶  interactive SVG
                                                            pan · zoom · filter · drill
```
