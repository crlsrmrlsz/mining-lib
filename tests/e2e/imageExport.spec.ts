...
// phase32.built.html auto-loads the n5 fixture through loadLog and exposes
...
const PAGE = "/phase32.built.html?fixture=n5-fixture";
...
test("export frames content dragged outside the dagre layout box (no clipping)", async ({
  ...
  await page.goto("/phase32.built.html?fixture=n5-fixture&w=640&h=480");
  await waitForReady(page);
