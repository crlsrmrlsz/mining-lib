...
// The phase30 demo pages load through `loadLog` and expose `window.__text`
...
test("cold load misses then a warm load hits with identical structure", async ({ page }) => {
  await page.goto("/phase30.built.html?fixture=n5-fixture");
...
test("a second load after a page reload restores from IndexedDB", async ({ page }) => {
  ...
  await page.goto("/phase30.built.html?fixture=n1000-realistic");
